...
namespace SentimentModel.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"/Users/nikeshbiraggari/Desktop/Files/dotnet/myMLApp/yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.043809354F,L2Regularization=0.41974947F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
